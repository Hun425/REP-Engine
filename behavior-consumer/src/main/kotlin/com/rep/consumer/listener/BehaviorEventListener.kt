...
class BehaviorEventListener(
    ...
    private val virtualThreadDispatcher: CloseableCoroutineDispatcher,
) {
    private val processedCounter: Counter =
        Counter
            .builder("kafka.consumer.processed")
            .tag("topic", "user.action.v1")
            .register(meterRegistry)

    private val indexedCounter: Counter =
        Counter
            .builder("kafka.consumer.indexed")
            .tag("topic", "user.action.v1")
            .register(meterRegistry)

    private val errorCounter: Counter =
        Counter
            .builder("kafka.consumer.errors")
            .tag("topic", "user.action.v1")
            .register(meterRegistry)

    private val consumeTimer: Timer =
        Timer
            .builder("kafka.consumer.batch.duration")
            .tag("topic", "user.action.v1")
    ...
    private val batchSizeSummary: DistributionSummary =
        DistributionSummary
            .builder("kafka.consumer.batch.size")
            .tag("topic", "user.action.v1")
