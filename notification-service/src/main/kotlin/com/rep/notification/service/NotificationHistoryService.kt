 ...
 *
 * @see docs/phase 4.md - 알림 이력 저장
 */
@Component
class NotificationHistoryService(
    private val esClient: ElasticsearchClient,
    @Value("\${elasticsearch.index.notification-history:notification_history_index}") private val historyIndex: String,
    meterRegistry: MeterRegistry,
) {
    private val saveSuccessCounter =
        Counter
            .builder("notification.history.save.success")
            .description("Notification history saved successfully")
            .register(meterRegistry)

    private val saveFailedCounter =
        Counter
            .builder("notification.history.save.failed")
        ...
        try {
            val document =
                mapOf(
                    ...
                    "traceId" to notification.traceId?.toString(),
                )
