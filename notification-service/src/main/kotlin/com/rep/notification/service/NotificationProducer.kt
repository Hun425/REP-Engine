 ...
 *
 * @see docs/phase 4.md - Notification Producer
 */
@Component
class NotificationProducer(
    ...
    private val sendSuccessCounter =
        Counter
            .builder("notification.send.success")
            .description("Notifications sent successfully")
            .register(meterRegistry)

    private val sendFailedCounter =
        Counter
            .builder("notification.send.failed")
